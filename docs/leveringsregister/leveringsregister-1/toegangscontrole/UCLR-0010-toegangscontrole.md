...
- **Omschrijving:** Uitvoeren van GraphQL-query [`QLR-0010-ZK.graphql`graphql](https://github.com/iStandaarden/iWlz-levering/tree/Leveringsregister-1/gql-query/zorgkantoor/QLR-0010-ZK.graphql) op het Leveringsregister door een zorgkantoor
...
> Toegang tot het Leveringsregister via query [`QLR-0010-ZK.graphql`graphql](https://github.com/iStandaarden/iWlz-levering/tree/Leveringsregister-1/gql-query/zorgkantoor/QLR-0010-ZK.graphql) is **alleen toegestaan** als:
>
