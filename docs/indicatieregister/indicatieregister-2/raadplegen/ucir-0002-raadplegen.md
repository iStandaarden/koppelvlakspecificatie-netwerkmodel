...
|---|---|---|---|
| [QIR-0002-ZA.graphql](https://github.com/iStandaarden/iWlz-indicatie/tree/Indicatieregister-2/gql-query/zorgaanbieder/QIR-0002-ZA.graphql) |  Op basis van de (opgehaalde) wlzIndicatieID en eigen identificatie, de bijbehorende WlzIndicatie raadplegen inclusief cliëntgegevens | `wlzIndicatieID` | Alle klassen/nodes |
...
| 6. | De **Zorgaanbieder** vult de verplichte **```wlzIndicatieID```** in query-template [QIR-0002-ZA.graphqlgraphql](https://github.com/iStandaarden/iWlz-indicatie/tree/Indicatieregister-2/gql-query/zorgaanbieder/QIR-0002-ZA.graphql) en initieert een raadpleging van de Wlz-indicatie in het Indicatieregister. | 
