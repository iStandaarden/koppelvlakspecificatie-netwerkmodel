...
- **Omschrijving:** Uitvoeren van GraphQL-query [`QIR-0003-ZKn.graphql`graphql](https://github.com/iStandaarden/iWlz-indicatie/tree/Indicatieregister-3/gql-query/zorgkantoor/QIR-0003-ZKn.graphql) op het Indicatieregister door een zorgkantoor.
...
> Toegang tot het Indicatieregister via query [`QIR-0003-ZKn.graphql`graphql](https://github.com/iStandaarden/iWlz-indicatie/tree/Indicatieregister-3/gql-query/zorgkantoor/QIR-0003-ZKn.graphql) is **alleen toegestaan** als:
>
