...
- **Omschrijving:** Uitvoeren van GraphQL-query [QBR-0011-CIZ.graphqlgraphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1/gql-query/ciz/QBR-0011-CIZ.graphql) op het bemiddelingsregister door het CIZ
...
> Toegang tot het Bemiddelingsregister via query [`QBR-0011-CIZ.graphql`graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1/gql-query/ciz/QBR-0011-CIZ.graphql) is **alleen toegestaan** als:
>
