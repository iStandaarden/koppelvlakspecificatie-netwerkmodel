...
- **Omschrijving:** Uitvoeren van GraphQL-query [`QBR-0007-ZKn.graphql`graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1/gql-query/zorgkantoor/QBR-0007-ZKn.graphql) op het bemiddelingsregister door een zorgkantoor.
...
> Toegang tot het Bemiddelingsregister via query [`QBR-0007-ZKn.graphql`graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1/gql-query/zorgkantoor/QBR-0007-ZKn.graphql) is **alleen toegestaan** als:
>
