...
- **Omschrijving:** Uitvoeren van GraphQL-query [`QBR-0002-ZA.graphql`graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1/gql-query/zorgaanbieder/QBR-0002-ZA.graphql) of [`QBR-0003-ZA.graphql`graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1/gql-query/zorgaanbieder/QBR-0003-ZA.graphql) (wanneer de eigen `bemiddelingspecificatie` een einddatum heeft) op het bemiddelingsregister door een zorgaanbieder. 
...
> Toegang tot het Bemiddelingsregister via query [`QBR-0002-ZA.graphql`graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1/gql-query/zorgaanbieder/QBR-0002-ZA.graphql) of [`QBR-0003-ZA.graphql`graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1/gql-query/zorgaanbieder/QBR-0003-ZA.graphql) is **alleen toegestaan** als:
>
