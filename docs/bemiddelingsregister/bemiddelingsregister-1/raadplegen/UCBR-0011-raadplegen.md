...
| :---- | :---- | :---- | :---- | 
| [QBR-0011-CIZ.graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1/gql-query/ciz/QBR-0011-CIZ.graphql) | Op basis van het wlzIndicatieID de zorgkantoren die als uitvoerend zorgkantoor betrokken zijn, zijn geweest raadplegen. | `wlzIndicatieID` |  Bemiddeling / Bemiddelingspecificatie | 
...
| 6. | Het CIZ vult de verplichte **`wlzIndicatieID`** in query-template [QBR-0011-CIZ.graphqlgraphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1/gql-query/ciz/QBR-0011-CIZ.graphql) en initieert een raadpleging van het Bemiddelingsregister. | 
