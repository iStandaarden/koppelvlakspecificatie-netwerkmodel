...
|---|---|---|---|
| [**QBR-0010-CIZ**.graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1/gql-query/ciz/QBR-0010-CIZ.graphql) | Op basis van de wlzIndicatieID de betrokken zorgkantoren raadplegen. | `wlzIndicatieID` | Bemiddeling.verantwoordelijkZorgkantoor  |
...
| 6. | Het CIZ vult de verplichte **`wlzIndicatieID`** in query-template [QBR-0010-CIZ.graphqlgraphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1/gql-query/ciz/QBR-0010-CIZ.graphql) en initieert een raadpleging van het Bemiddelingsregister. | 
