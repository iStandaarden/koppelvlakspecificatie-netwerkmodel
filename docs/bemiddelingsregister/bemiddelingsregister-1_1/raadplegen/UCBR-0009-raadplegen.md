...
|---|---|---|---|
| [**QBR-0009-ZA**.graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1_1/gql-query/zorgaanbieder/QBR-0009-ZAr.graphql) | Op basis van de (ontvangen) regiehouderID en eigen identificatie, de Regiehouder, Bemiddeling en Cliënt gegevens raadplegen | `regiehouderID`,  `AGBcode` | Regiehouder /  Bemiddeling /  Client |
