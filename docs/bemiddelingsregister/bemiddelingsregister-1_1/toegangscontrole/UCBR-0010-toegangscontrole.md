...
- **Omschrijving:** Uitvoeren van GraphQL-query [`QBR-0010-CIZ.graphql`graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1_1/gql-query/ciz/QBR-0010-CIZ.graphql) op het bemiddelingsregister door het CIZ
...
> Toegang tot het Bemiddelingsregister via query [`QBR-0010-CIZ.graphql`graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1_1/gql-query/ciz/QBR-0010-CIZ.graphql) is **alleen toegestaan** als:
>
