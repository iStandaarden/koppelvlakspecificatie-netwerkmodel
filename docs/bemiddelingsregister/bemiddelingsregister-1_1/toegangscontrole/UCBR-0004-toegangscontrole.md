...
- **Omschrijving:** Uitvoeren van GraphQL-query [`QBR-0004-ZK.graphql`graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1_1/gql-query/zorgkantoor/QBR-0004-ZKu.graphql) op het bemiddelingsregister door een zorgkantoor.
...
> Toegang tot het Bemiddelingsregister via query [`QBR-0004-ZKu.graphql`graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1_1/gql-query/zorgkantoor/QBR-0004-ZKu.graphql) is **alleen toegestaan** als:
>
