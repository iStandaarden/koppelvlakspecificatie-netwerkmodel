...
- **Omschrijving:** Uitvoeren van GraphQL-query [`QBR-0005-ZKu.graphql`graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1_1/gql-query/zorgkantoor/QBR-0005-ZKu.graphql) of [`QBR-0006-ZKu.graphql`graphql](https://github.com/iStandaarden/iWlz-bemiddeling/tree/Bemiddelingsregister-1_1/gql-query/zorgkantoor/QBR-0006-ZKu.graphql) (wanneer de eigen `bemiddelingspecificatie` een einddatum heeft) op het bemiddelingsregister door een zorgaanbieder. 
